...
public class DateChooser extends JDialog {
    ...
    //Выбор даты
    public DateChooser(Point e, JTable films, Window owner) {
        ...
        setDate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (e.getSource() == setDate) {
                    String str = daySpin.getValue() + "." + monthSpin.getValue() + "." + yearSpin.getValue();
                    films.setValueAt(str, films.getSelectedRow(), films.getSelectedColumn());
                    dateChoser.dispose();
                }
            }
        });
